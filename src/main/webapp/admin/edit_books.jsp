				...
				<div class="card">
					<div class="card-body">
                        ...
                        <div class="form-group"> 
                             ...
                             placeholder="Enter Full Name" required="required" name="fname" value="<%=b.getBookname()%>">
                         </div>

                         <div class="form-group">
                              <label for="exampleInputEmail1">Author Name*</label>
                               <input name="author" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" 
                               placeholder="Enter email" required="required" name="email" value="<%=b.getAuthor()%>">
                          </div>
                           ...
                           <div class="form-group">
                            ...
                            placeholder="Enter Phone Number" required="required" name="phone" value="<%=b.getPrice()%>">
                          </div>
